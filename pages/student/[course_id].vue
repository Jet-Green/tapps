  ...
  <v-container v-if="currentCourse">
    ...
    <v-row>
      <v-col cols="12" sm="6" md="4" lg="3" v-if="authStore.user?.roles[0] == 'teacher'">
        <div class="border rounded-lg cursor-pointer h-100 d-flex justify-center align-center" @click="router.push(`/add-lesson?course_id=${route.params.course_id}`)" style="font-size: 40px;">
