...
const { value: link, errorMessage: linkError, setValue: setLink } = useField("link")
if (props.data?.name) {
...
<template>
  <form @submit="submitForm">
    <v-card>
      ...
      <v-card-actions>
        <v-btn class="submit-btn" variant="tonal" prepend-icon="mdi-plus" type="submit">Готово</v-btn>
      </v-card-actions>
    </v-card>
  </form>
</template>
